...
function BannerSaleCard() {
  return (
    <div className="bottom-4 left-4 flex h-26.25 overflow-hidden rounded-3xl bg-[#EFEFEF33] pr-5 shadow-[inset_0.5px_0.3px_0_rgba(255,255,255,0.65),0_0_0_0.4px_rgba(255,255,255,0.45)] lg:absolute">
